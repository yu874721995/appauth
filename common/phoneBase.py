# -*- coding : utf-8 -*-
# @Auther    : Careslten
# @time      : 2021/8/25 18:00
# @File      : phoneBase.py
# @SoftWare  : dengta_appauto
import os
import subprocess
import math
...
def get_phone_info(devices):
    ...
    cmd = "adb root && adb -s "+ devices +" shell cat /system/build.prop"
...
if __name__=="__main__":
    get_phone_info("2NSDU20526034332")
    # print(get_phone_info("2NSDU20526034332"))